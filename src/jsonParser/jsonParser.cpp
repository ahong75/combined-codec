...
void jsonParser::substitutionError() {
  jsonParser::substitutionErrorRate =
      (double)j["simulation"]["error"]["substitution"];
}
...
void jsonParser::unorderedOutputFile() {
  jsonParser::unorderedOutput =
      j["simulation"]["output"]["unorderedOutputFileName"];
}
void jsonParser::orderedOutputFile() {
  jsonParser::orderedOutput =
      j["simulation"]["output"]["orderedOutputFileName"];
}
